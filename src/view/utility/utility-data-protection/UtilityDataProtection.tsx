...
const UtilityDataProtection = () => {
    return (
        <div className="utility-data-protection">
            ...
            <div className="utility-data-protection__content">
                <div className="utility-data-protection__content__section">
                ...
                <div className="utility-data-protection__content__section">
                    ...
                    <p>
                        ...
                        a DSGVO und § 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von
